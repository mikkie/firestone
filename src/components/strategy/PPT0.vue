          ...
          <b-row no-gutters>
            ...
            <b-col lg="2">
              <b-form-input
                ...
                min="1"
                max="5"
                v-model="strategy.parameters.money.time"
              ></b-form-input>
            </b-col>
            <b-col lg="2">
            ...
            <b-col lg="2">
              <b-form-input
                ...
                min="10"
                max="50000"
                v-model="strategy.parameters.money.amount"
              ></b-form-input>
            </b-col>
          </b-row>
          <b-row no-gutters>
            ...
            <b-col lg="2">
              <b-form-input
                ...
                maxlength="5"
                id="stop_win"
                v-model="strategy.parameters.stop_win"
              ></b-form-input>
            </b-col>
            <b-col lg="2">
              <label for="drop_from_high">回调:</label>
            </b-col>
            <b-col lg="2">
              <b-form-input
                size="sm"
                maxlength="5"
                id="drop_from_high"
                v-model="strategy.parameters.drop_from_high"
              ></b-form-input>
            </b-col>
          </b-row>
          <b-row no-gutters>
